    ...
    <div style={style}>
      ...
      <div className="p-8 flex flex-col justify-center items-center w-full h-screen gap-2">
        <h1 className=" text-5xl text-white font-poppins font-semibold">
          Made <span className="text-cyan-500">Fresh</span>. Priced{" "}
          <span className="text-cyan-500">Fair</span>. 100%{" "}
          <span className="text-cyan-500">Halal</span>.
        </h1>
        ...
        <div className="mt-4 p-2.5 cursor-pointer  border-2 flex justify-center items-center  rounded-xl gap-2">
          <button className="relative text-xl overflow-hidden cursor-pointer text-white rounded-2xl border border-cyan-500 px-6 py-2.5 group flex justify-center items-center">
            ...
            <span className="absolute inset-0 bg-cyan-500 scale-x-0 origin-left transition-transform duration-300 group-hover:scale-x-100"></span>
          </button>
        </div>
      </div>
    </div>
